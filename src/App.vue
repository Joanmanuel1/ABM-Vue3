        ...
        <form @submit.prevent="agregarUsuario">
          ...
          <div class="col m4">
            ...
            <select v-model="estado_civil">
              ...
              <option v-for="estado in estados_civiles" v-bind:key="estado.id" v-bind:value="estado.descripcion">
          ...
          <form @submit.prevent="agregarPasatiempo">
            <div class="col m4">
              ...
              <button type="submit" class="btn indigo darken-3">Agregar Pasatiempo <i
      ...
      <table class="table bordered striped">
        ...
        <tbody>
          <tr v-for="(usuario, index) in usuarios" v-bind:key="usuario" v-bind:class="{'indigo darken-4 white-text': index == indice}">
            ...
            <td>
              <label>
                <input type="checkbox" name="" id="" disabled v-model="usuario.suscrito">
                <span></span>
              </label>
            </td>
